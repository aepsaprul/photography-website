      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><a href="{{ route('tentang.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i></a></h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                  ...
                  <tr>
                      ...
                      <td>
                          <div class="btn-group">
                              ...
                              <a href="{{ route('tentang.hapus', [$tentang->id]) }}" onclick="return confirm('Yakin akan hapus?')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                          </div>
                      </td>
                  </tr>
              @endforeach
